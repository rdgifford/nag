...
var scheduler = function() {
  // AUTO INTRO
  schedule.scheduleJob(process.env.AUTOINTROFREQ, function() {
  ...
  // CHORE REMINDERS
  schedule.scheduleJob(process.env.CHOREREMINDERREFRESH, function() {
    var reminderType = {
      'ready?': function(obj) {
    ...
    forEachObj("/chores", true, function(chore, obj, i, chores) {
      ...
      if (lastReminder > process.env.CHOREREMINDERFREQ && reminderType[obj.reminderType + "?"](obj)) {
